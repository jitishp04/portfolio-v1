                    ...
                    return (
                        <div
                            ...
                            style={{
                                ...
                                width: `${Math.round((seed(0) * 4 + 1) * 100) / 100}px`,
                                height: `${Math.round((seed(1) * 4 + 1) * 100) / 100}px`,
                                top: `${Math.round(seed(2) * 10000) / 100}%`,
                                left: `${Math.round(seed(3) * 10000) / 100}%`,
                                animation: `float ${Math.round((seed(4) * 10 + 20) * 100) / 100}s linear infinite`,
                                animationDelay: `${Math.round(seed(5) * 2000) / 100}s`,
                            }}
                        />
                    );
                })}
                            ...
                            >
                                ...
                                >
                                    ...
                                    {card.linkButtons ? (
                                        ...
                                        <div className="flex flex-col gap-3 mt-2 flex-1 justify-center">
                                            {card.linkButtons.map((btn, i) => (
                                                <a
                                                    ...
                                                    className="flex items-center gap-3 px-5 py-3 rounded-full transition-all duration-300 hover:scale-[1.03] group/btn"
                                                    style={{
                                                ...
                                                >
                                                    ...
                                                    <svg
                                                        ...
                                                        strokeLinecap="round"
                                                        strokeLinejoin="round"
                                                        className="ml-auto opacity-50 group-hover/btn:opacity-100 transition-opacity"
                                                    >
                                        ...
                                        /* ═══ DEFAULT LAYOUT (description + tags + GitHub) ═══ */
                                        <>
                                            {/* Full description */}
